...
export type Platform = 'anthropic' | 'openai' | 'xai' | 'antigravity' | 'gemini'
...
const BADGE: Record<Platform, string> = {
  ...
  xai: 'bg-zinc-500/10 text-zinc-700 border-zinc-500/30 dark:text-zinc-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  xai: 'bg-zinc-500/10 text-zinc-700 dark:bg-zinc-500/10 dark:text-zinc-300',
...
const BORDER: Record<Platform, string> = {
  ...
  xai: 'border-zinc-500/20 dark:border-zinc-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  xai: 'bg-gradient-to-r from-zinc-500 to-neutral-700',
...
const BUTTON: Record<Platform, string> = {
  ...
  xai: 'bg-zinc-800 text-white hover:bg-zinc-900 active:bg-black dark:bg-zinc-700 dark:hover:bg-zinc-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  xai: 'bg-zinc-100 text-zinc-700 dark:bg-zinc-800/60 dark:text-zinc-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  xai: 'from-zinc-700 to-neutral-900',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'xai' || p === 'antigravity' || p === 'gemini'
}
